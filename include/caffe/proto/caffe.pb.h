...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.UpsampleParameter upsample_param = 149;
  inline bool has_upsample_param() const;
  inline void clear_upsample_param();
  static const int kUpsampleParamFieldNumber = 149;
...
inline ::google::protobuf::int32 UpsampleParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.UpsampleParameter.scale)
  return scale_;
}
inline void UpsampleParameter::set_scale(::google::protobuf::int32 value) {
  set_has_scale();
  scale_ = value;
